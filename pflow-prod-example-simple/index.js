const json = {
  title: "Пройдите Опрос о качестве \"Ai Burgers!\"",
      ...
      questions: [  // Разбивка на блоки / вопросы -- через список объектов `questions`
        {
          type: "html",
          name: "description",
          html: "<h6>Спасибо, что посетили \"Ai Burger!\" — поделитесь вашим мнением в нашем коротком опросе, чтобы помочь нам улучшиться, а также получите шанс выиграть подарочный сертификат!</h6>",
        },
        {
          type: "rating",
          name: "satisfaction",
